...
/*
  ...
  int debug          1: show the image given to the network and print the embedding, 0: don't show
  extra info
...
/*
  ...
  float theta - the orientation of the primary axis of the region (first eigenvector / least 2nd
  central moment float minE1 - the minimum projection value along the primary axis (should be a
  negative value) float maxE1 - the maximum projection value along the primary axis (should be a
  positive value) float minE2 - the minimum projection value along the secondary axis (should be a
  negative value) float maxE2 - the maximum projection value along the secondary axis (should be a
  positive value) int debug - whether to show intermediate images and values
